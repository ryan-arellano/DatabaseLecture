...
CREATE TABLE `customers`  (
  ...
  `contactLastName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `contactFirstName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `addressLine1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `addressLine2` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `postalCode` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  INDEX `salesRepEmployeeNumber`(`salesRepEmployeeNumber` ASC) USING BTREE,
...
CREATE TABLE `employees`  (
  ...
  `officeCode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `reportsTo` int NULL DEFAULT NULL,
  `jobTitle` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`employeeNumber`) USING BTREE,
  INDEX `reportsTo`(`reportsTo` ASC) USING BTREE,
  INDEX `officeCode`(`officeCode` ASC) USING BTREE,
...
CREATE TABLE `offices`  (
  ...
  `territory` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `orderdetails`  (
  ...
  `productCode` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `quantityOrdered` int NOT NULL,
  `priceEach` decimal(10, 2) NOT NULL,
  `orderLineNumber` smallint NOT NULL,
  PRIMARY KEY (`orderNumber`, `productCode`) USING BTREE,
  INDEX `productCode`(`productCode` ASC) USING BTREE,
...
CREATE TABLE `orders`  (
  ...
  INDEX `customerNumber`(`customerNumber` ASC) USING BTREE,
...
CREATE TABLE `productlines`  (
  `productLine` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `textDescription` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `htmlDescription` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
...
CREATE TABLE `products`  (
  ...
  `productLine` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `productScale` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `productVendor` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  INDEX `productLine`(`productLine` ASC) USING BTREE,
